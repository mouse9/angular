...
export class SharedFilesComponent implements OnInit {
  ...
  @ViewChild('dropdownlistitems', { static: false }) dropdownlistitems: ElementRef;
  @ViewChild('dropdownlistitems', { static: false }) set content(content: ElementRef) {
    if(content) { // initially setter gets called with undefined
        this.dropdownlistitems = content;
    }
 }
  ...
  closeMoveFile() {
    this.showAPISerValidationErrMsg = false;
    this.toggleLightBoxForFileModal();
  ...
  toggleLightBoxForFileModal() {
    this.moveFileModal.nativeElement.toggle();
    this.dropdownlistitems.nativeElement.$['results-container'].style['max-height'] = '125px'                       
  }
